...
Organization: Ministry of Petroleum & Natural Gas | Theme: Smart Automation
...
app = FastAPI(
    title="SIH26100 Operational Engine",
    description="AI-Powered Integrated Bid Compliance Verification Platform for GeM Procurement - Backend Service (Ministry of Petroleum & Natural Gas)",
    version="2.0.0"
)
...
class AnalysisRequest(BaseModel):
    ...
    location_label: Optional[str] = Field(None, example="Ministry of Petroleum & Natural Gas")
    metadata: Optional[Dict[str, Any]] = None

@app.get("/")
def read_root():
    return {
        "service": "SIH26100 API Engine",
...
def analyze_telemetry(payload: AnalysisRequest):
    ...
    return {
        ...
        "timestamp": datetime.utcnow().isoformat(),
        "action_taken": "Automated alert webhook dispatched to Ministry of Petroleum & Natural Gas SPOC" if is_anomaly else "Telemetry logged in Supabase database"
    }
