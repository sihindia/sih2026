...
app = FastAPI(
    title="SIH26045 Operational Engine",
    description="IP-SAKTI Sahayak a multilingual, RAG-based (source-cited) AI assistant for Intellectual Property and regulatory guidance in Ayurveda, across national and international regimes. - Backend Service (Ministry of Ayush)",
    version="2.0.0"
)
