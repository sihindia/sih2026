...
app = FastAPI(
    title="SIH26076 Operational Engine",
    description="Development of personalized homepage for 'Mausam' mobile application: - Backend Service (Ministry of Earth Sciences (MoES))",
    version="2.0.0"
)
