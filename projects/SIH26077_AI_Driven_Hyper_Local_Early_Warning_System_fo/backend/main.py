...
app = FastAPI(
    title="SIH26077 Operational Engine",
    description="AI-Driven Hyper-Local Early Warning System for Severe Weather Nowcasting - Backend Service (Ministry of Earth Sciences (MoES))",
    version="2.0.0"
)
