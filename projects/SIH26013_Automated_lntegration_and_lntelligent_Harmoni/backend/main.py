...
app = FastAPI(
    title="SIH26013 Operational Engine",
    description="Automated lntegration and lntelligent Harmonization of Multi-source Geospatial Data for urban Land Record Management. - Backend Service (Ministry of Rural Development)",
    version="2.0.0"
)
