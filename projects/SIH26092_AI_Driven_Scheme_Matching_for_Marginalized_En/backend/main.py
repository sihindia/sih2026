...
Organization: Ministry of Social Justice and Empowerment (MoSJE) | Theme: Smart Automation
...
app = FastAPI(
    title="SIH26092 Operational Engine",
    description="AI-Driven Scheme Matching for Marginalized Entrepreneurs - Backend Service (Ministry of Social Justice and Empowerment (MoSJE))",
    version="2.0.0"
)
