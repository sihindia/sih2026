...
app = FastAPI(
    title="SIH26014 Operational Engine",
    description="An lntegrated GIS-based Digital Public lnfrastructure for Land Governance - Backend Service (Ministry of Rural Development)",
    version="2.0.0"
)
