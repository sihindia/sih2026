...
app = FastAPI(
    title="SIH26120 Operational Engine",
    description="Digital Twin for Well-to-Surface Optimization of Cyclic Steam Stimulation (CSS) and Sucker Rod Pump (SRP) Operations for Heavy Oil Wells of Baghewala Field. - Backend Service (Oil India Limited)",
    version="2.0.0"
)
