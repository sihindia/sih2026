...
app = FastAPI(
    title="SIH26099 Operational Engine",
    description="AI-Driven Standardization and Harmonization of Material Codes Across CPSEs - Backend Service (Ministry of Petroleum & Natural Gas)",
    version="2.0.0"
)
