...
Organization: Ministry of Earth Sciences (MoES) | Theme: Transportation & Logistics
...
app = FastAPI(
    title="SIH26059 Operational Engine",
    description="AI-Enabled Antarctic Sea-Ice, Iceberg Trajectory, and Navigation Decision Support System - Backend Service (Ministry of Earth Sciences (MoES))",
    version="2.0.0"
)
