...
app = FastAPI(
    title="SIH26069 Operational Engine",
    description="National Weather Big Data Analytics Platform - Backend Service (Ministry of Earth Sciences (MoES))",
    version="2.0.0"
)
