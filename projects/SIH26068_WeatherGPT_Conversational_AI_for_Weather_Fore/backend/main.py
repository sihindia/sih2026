...
app = FastAPI(
    title="SIH26068 Operational Engine",
    description="WeatherGPT: Conversational AI for Weather Forecasting, Alerts, and Climate Information - Backend Service (Ministry of Earth Sciences (MoES))",
    version="2.0.0"
)
