...
app = FastAPI(
    title="SIH26057 Operational Engine",
    description="AI-Powered Automated Underwater Marine Debris and Anomaly Detection System using Side-Scan Sonar Imagery - Backend Service (Ministry of Earth Sciences (MoES))",
    version="2.0.0"
)
