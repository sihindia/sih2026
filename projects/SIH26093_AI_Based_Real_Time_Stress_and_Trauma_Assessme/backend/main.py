...
app = FastAPI(
    title="SIH26093 Operational Engine",
    description="AI-Based Real-Time Stress and Trauma Assessment Module for Victims/Complainants Accessing NHAA (14566) and Integrated Portal - Backend Service (Ministry of Social Justice and Empowerment (MoSJE))",
    version="2.0.0"
)
