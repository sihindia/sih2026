...
app = FastAPI(
    title="SIH26073 Operational Engine",
    description="AI/ML-Based Intelligent Anomaly Detection for Automatic Weather Stations (AWS) - Backend Service (Ministry of Earth Sciences (MoES))",
    version="2.0.0"
)
