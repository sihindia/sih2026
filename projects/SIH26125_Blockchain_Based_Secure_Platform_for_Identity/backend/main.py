...
Organization: Bharat Electronics Limited | Theme: Blockchain & Cybersecurity
...
app = FastAPI(
    title="SIH26125 Operational Engine",
    description="Blockchain-Based Secure Platform for Identity,Access Control, and Digital Asset Management - Backend Service (Bharat Electronics Limited)",
    version="2.0.0"
)
