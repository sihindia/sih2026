...
app = FastAPI(
    title="SIH26106 Operational Engine",
    description="AI-Powered Email Threat Detection, GeoLocation and Forensic Intelligence Platform - Backend Service (All India Council for Technical Education (AICTE))",
    version="2.0.0"
)
