...
app = FastAPI(
    title="SIH26032 Operational Engine",
    description="Farmers often face long waiting times, lack of information regarding procurement schedules, and uncertainty about procurement status. - Backend Service (Ministry of Consumer Affairs, Food & Public Distribution)",
    version="2.0.0"
)
