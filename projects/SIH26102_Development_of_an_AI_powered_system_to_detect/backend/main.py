...
app = FastAPI(
    title="SIH26102 Operational Engine",
    description="Development of an AI-powered system to detect anomalies, fraud, and inefficiencies in MPLAD Scheme implementation regd. - Backend Service (MoSPI)",
    version="2.0.0"
)
