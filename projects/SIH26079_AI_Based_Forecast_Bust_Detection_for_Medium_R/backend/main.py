...
app = FastAPI(
    title="SIH26079 Operational Engine",
    description="AI-Based Forecast Bust Detection for Medium-Range Weather Forecasts - Backend Service (Ministry of Earth Sciences (MoES))",
    version="2.0.0"
)
