...
Organization: DRDO | Theme: Smart Vehicles
...
app = FastAPI(
    title="SIH26053 Operational Engine",
    description="Adaptive Variable Resolution 2.5D Lidar Mapping for Dynamic Environment Perception - Backend Service (DRDO)",
    version="2.0.0"
)
