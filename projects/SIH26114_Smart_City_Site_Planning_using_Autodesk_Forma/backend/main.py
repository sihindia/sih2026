...
app = FastAPI(
    title="SIH26114 Operational Engine",
    description="Smart City Site Planning using Autodesk Forma Site Design - Backend Service (Autodesk)",
    version="2.0.0"
)
