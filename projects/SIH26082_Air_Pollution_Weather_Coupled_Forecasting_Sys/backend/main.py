...
app = FastAPI(
    title="SIH26082 Operational Engine",
    description="Air Pollution–Weather Coupled Forecasting System (Delhi NCR Focus) - Backend Service (Ministry of Earth Sciences (MoES))",
    version="2.0.0"
)
