...
Organization: AICTE | Theme: Robotics and Drones
...
app = FastAPI(
    title="SIH26201 Operational Engine",
    description="Student Innovation-There is a need to design drones and robots that can solve some of the pressing challenges of India such as handling medical emergencies, search and rescue operations, etc. - Backend Service (AICTE)",
    version="2.0.0"
)
