...
Organization: Ministry of Consumer Affairs, Food & Public Distribution | Theme: Miscellaneous
...
app = FastAPI(
    title="SIH26034 Operational Engine",
    description="Software System to check compliance of Packaged Commodities under Legal Metrology(Packaged Commodities) Rules, 2011 by scanning products, images and labels. - Backend Service (Ministry of Consumer Affairs, Food & Public Distribution)",
    version="2.0.0"
)
