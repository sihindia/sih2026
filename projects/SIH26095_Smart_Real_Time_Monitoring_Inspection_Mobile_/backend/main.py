...
app = FastAPI(
    title="SIH26095 Operational Engine",
    description="Smart Real-Time Monitoring & Inspection Mobile App - Backend Service (Ministry of Social Justice and Empowerment (MoSJE))",
    version="2.0.0"
)
