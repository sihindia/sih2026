...
app = FastAPI(
    title="SIH26011 Operational Engine",
    description="3D ULPIN Generation and vertical Property Mapping SYstem - Backend Service (Ministry of Rural Development)",
    version="2.0.0"
)
