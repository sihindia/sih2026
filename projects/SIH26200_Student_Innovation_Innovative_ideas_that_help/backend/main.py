...
Organization: AICTE | Theme: Renewable / Sustainable Energy
...
app = FastAPI(
    title="SIH26200 Operational Engine",
    description="Student Innovation-Innovative ideas that help manage and generate renewable /sustainable sources more efficiently - Backend Service (AICTE)",
    version="2.0.0"
)
