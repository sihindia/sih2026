...
app = FastAPI(
    title="SIH26054 Operational Engine",
    description="AI-Enabled Real-Time Digital Twin System for Health Monitoring, Fault Prediction and Mission Reliability Enhancement of Aero Piston Engines used in MALE UAVs. - Backend Service (DRDO)",
    version="2.0.0"
)
