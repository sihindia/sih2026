...
app = FastAPI(
    title="SIH26001 Operational Engine",
    description="AI-Based early warning and landslide Risk Monitoring System in NER - Backend Service (Ministry of Development of North Eastern Region (MDoNER))",
    version="2.0.0"
)
