...
Organization: Ministry of Steel | Theme: Space Technology
...
app = FastAPI(
    title="SIH26009 Operational Engine",
    description="Using AI/ML and Space Technology to Identify Manganese Reserves and Overcome Production Shortfalls. - Backend Service (Ministry of Steel)",
    version="2.0.0"
)
