...
Organization: AICTE | Theme: Transportation & Logistics
...
app = FastAPI(
    title="SIH26205 Operational Engine",
    description="Student Innovation-Submit your ideas to address the growing pressures on the city’s resources, transport networks, and logistic infrastructure. - Backend Service (AICTE)",
    version="2.0.0"
)
