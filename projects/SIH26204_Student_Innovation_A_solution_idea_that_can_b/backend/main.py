...
Organization: AICTE | Theme: Travel & Tourism
...
app = FastAPI(
    title="SIH26204 Operational Engine",
    description="Student Innovation-A solution/idea that can boost the current situation of the tourism industries including hotels, travel and others. - Backend Service (AICTE)",
    version="2.0.0"
)
