...
app = FastAPI(
    title="SIH26094 Operational Engine",
    description="AI-Powered Dynamic Mental Health Monitoring and Distress Prediction System for Victims of Atrocities - Backend Service (Ministry of Social Justice and Empowerment (MoSJE))",
    version="2.0.0"
)
