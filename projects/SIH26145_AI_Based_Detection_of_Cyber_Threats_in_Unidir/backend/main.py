...
app = FastAPI(
    title="SIH26145 Operational Engine",
    description="AI-Based Detection of Cyber Threats in Unidirectional IP Traffic - Backend Service (National Technical Research Organisation (NTRO))",
    version="2.0.0"
)
