...
app = FastAPI(
    title="SIH26056 Operational Engine",
    description="Development of a Real-time Airfare Price Index for India through Automated Web Scraping of Airline and Online Travel Aggregator Portals for Augmentation of the Consumer Price Index (CPI). - Backend Service (MoSPI)",
    version="2.0.0"
)
