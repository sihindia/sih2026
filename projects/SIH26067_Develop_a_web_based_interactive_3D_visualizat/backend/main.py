...
app = FastAPI(
    title="SIH26067 Operational Engine",
    description="Develop a web-based interactive 3D visualization platform that integrates numerical ocean model outputs and in-situ observations. - Backend Service (Ministry of Earth Sciences (MoES))",
    version="2.0.0"
)
