...
app = FastAPI(
    title="SIH26083 Operational Engine",
    description="Extreme Heatwave Early Warning and Human Thermal Stress Index - Backend Service (Ministry of Earth Sciences (MoES))",
    version="2.0.0"
)
