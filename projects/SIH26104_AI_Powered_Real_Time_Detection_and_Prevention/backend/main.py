...
app = FastAPI(
    title="SIH26104 Operational Engine",
    description="AI-Powered Real-Time Detection and Prevention of Voice Cloning Impersonation Attacks - Backend Service (All India Council for Technical Education (AICTE))",
    version="2.0.0"
)
