...
Organization: Ministry of Railways | Theme: Smart Automation
...
app = FastAPI(
    title="SIH26028 Operational Engine",
    description="Dynamic Forecast of Expected Time of Arrival (ETA) for Coaching Trains - Backend Service (Ministry of Railways)",
    version="2.0.0"
)
