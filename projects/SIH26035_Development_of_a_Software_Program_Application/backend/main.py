...
app = FastAPI(
    title="SIH26035 Operational Engine",
    description="Development of a Software Program/Application for Generation of Test Reports for Non-Automatic Weighing Instruments (NAWI) as per OIML Recommendation R- 76 - Backend Service (Ministry of Consumer Affairs, Food & Public Distribution)",
    version="2.0.0"
)
